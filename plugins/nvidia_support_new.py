...
class TabNvidiaVenv(QWidget):
    ...
    def initUI(self):
        ...
        # --- NVIDIA 特有 UI ---
        auto_layout.addWidget(QLabel("<b>1. 选择 PyTorch (CUDA) 版本:</b>"))
        ...
        self.nv_radio_tsinghua = QRadioButton("清华大学镜像源 (Tsinghua)")
        ...
        self.auto_create_venv_btn = QPushButton("开始创建 Venv 并安装 NVIDIA-Torch (CUDA)")
